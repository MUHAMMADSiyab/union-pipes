...
export default {
  ...
  data() {
    return {
      ...
      data: {
        ...
        capacity: "",
        no_of_chambers: 1,
        chambers: [{ id: 0, capacity: 0, dip_value: 0 }],
      },
    };
  },
  ...
  methods: {
    ...
    async update() {
      ...
      await this.updateVehicle(this.data);
    ...
    "data.no_of_chambers": {
      handler(no_of_chambers) {
        ...
        array.forEach((item, index) => {
          chambers.push({
            id: this.data.chambers[index] ? this.data.chambers[index].id : 0,
  ...
  async mounted() {
    ...
    await this.getVehicle(vehicle_id);
    ...
    this.data.engine_no = engine_no;
    this.data.chassis_no = chassis_no;
    this.data.make = make;
    this.data.model = model;
    this.data.contractor_name = contractor_name;
    this.data.validity = validity;
    this.data.calibration_date = calibration_date;
    this.data.capacity = capacity;
    this.data.receipt_no = receipt_no;
    this.data.no_of_chambers = chambers.length;
    this.data.chambers = chambers;
  },
};
</script>