      ...
      <v-row>
        <v-col cols="12">
          <v-card :loading="formLoading" :disabled="formLoading">
            <v-card-title primary-title>New Nozzle</v-card-title>
            <v-card-subtitle>Add a New Nozzle</v-card-subtitle>
...
export default {
  ...
  methods: {
    ...mapActions({
      ...
      addNozzle: "nozzle/addNozzle",
    }),

    async add() {
      this.formLoading = true;

      await this.addNozzle(this.data);
