      ...
      <v-row>
        <v-col cols="12">
          <v-card :loading="formLoading" :disabled="formLoading">
            <v-card-title primary-title>New Invoice</v-card-title>
            <v-card-subtitle>Add a New Invoice</v-card-subtitle>
...
export default {
  ...
  methods: {
    ...
    async add() {
      ...
      await this.addInvoice(this.data);
  ...
  mounted() {
    Promise.all([this.getCurrentRates(), this.getProducts()]);
  },
};
</script>