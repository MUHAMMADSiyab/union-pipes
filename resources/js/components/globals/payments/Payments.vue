  ...
  <div>
    <v-card v-if="!editMode" elevation="1">
      ...
      <v-card-subtitle v-if="entryType && type !== 'nonDialog'"
        >View {{ entryType }} payments <print-button
      /></v-card-subtitle>
      ...
      <v-card-text class="mt-1">
        ...
        >
          <!-- Top -->
          <template v-slot:top v-if="!printMode && type !== 'nonDialog'">
            <Excel
              module="payments"
          ...
          <template slot="item.actions" slot-scope="props">
            <v-menu offset-y>
              ...
              <v-list dense>
                ...
                <v-list-item
                  title="Delete"
                  @click="setPaymentId(props.item.id, props.item.model)"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { text: "S#", value: "sno" },
        { text: `Amount (${this.paymentSetting.currency})`, value: "amount" },
