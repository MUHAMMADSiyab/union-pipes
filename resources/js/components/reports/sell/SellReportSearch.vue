        ...
        <v-container class="mt-4">
            ...
            <v-row>
                <v-col cols="12">
                    ...
                    <SellReport v-if="reportData.length" :sells="reportData" />

                    <h4
                        class="ml-3 mt-3"
                        v-if="requestProcessed && !reportData.length"
                    >
                        No records
                    </h4>
                </v-col>
...
export default {
    ...
    methods: {
        ...mapActions({
            ...
            getSellReportData: "report/getSellReportData",
        }),
        ...
        async generate() {
            ...
            await this.getSellReportData(this.data);
