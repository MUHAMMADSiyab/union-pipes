        ...
        <v-container class="mt-4">
            ...
            <v-row>
                <v-col cols="12">
                    ...
                    >
                        <v-card-subtitle
                            >Generate production/stock report between date
...
import StockReport from "./StockReport.vue";
...
export default {
    ...
    methods: {
        ...mapActions({
            getStockReportData: "report/getStockReportData",
        }),
        ...
        async generate() {
            ...
            await this.getStockReportData(this.data);
