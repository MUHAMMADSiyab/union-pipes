        ...
        <v-container class="mt-4">
            ...
            <v-row>
                <v-col cols="12">
                    ...
                    >
                        <v-card-subtitle
                            >Generate machine report between date
...
import MachineReport from "./MachineReport.vue";
...
export default {
    ...
    methods: {
        ...mapActions({
            getMachineReportData: "report/getMachineReportData",
        }),
        ...
        async generate() {
            ...
            await this.getMachineReportData(this.data);
